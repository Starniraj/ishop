...
const Cart = () => {
    const { 
        ...
        emptyCart,
         ...
         if(isEmpty) return <h1 className='text-center'>Please add something</h1>
  return (
    ...
    <div className='row justify-content-center'>
        ...
        <div className='col-auto ms-auto'>
         ...
         <div className='col-auto'>
               ...
               <Link to="/buynow"><button className='btn btn-primary' style={{backgroundColor:"purple"}}>Buy Item(s)</button></Link>
         </div>
    </div>
    </section>
  )
